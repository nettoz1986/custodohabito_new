    ...
    container.innerHTML = `
      ...
      <div class="study-cards-grid">
        ${learningTracks.map((track) => `
          <button class="study-card" data-prompt="Trilha: ${track.title}. Duração: ${track.duration}. Contexto: ${track.description} ${track.prompt}">
        ...
        ${financeTools.map((tool) => `
          <button class="study-card" data-prompt="Ferramenta: ${tool.title}. Contexto: ${tool.description} Me ajude de forma aplicada, com perguntas curtas e próximo passo objetivo.">
      ...
      <div class="study-cards-grid">
        ${userProfiles.map((profile) => `
          <button class="study-card" data-prompt="Perfil de profundidade: ${profile.title}. Contexto: ${profile.description} Explique educação financeira nesse nível e monte próximos passos práticos.">
